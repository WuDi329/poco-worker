...
async function main() {
  ...
  executor.setTaskCompletionCallback(async (taskId, resultCid) => {
    console.log(`通过Listener更新任务 ${taskId} 完成状态`);
    return await nearConnection.completeTask(taskId, resultCid);
  });
